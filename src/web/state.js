...
const publicState = Object.freeze({ kanbanColumns, issueMap, allIssues, changedIssueKeys, applyStatusUpdate });
globalThis.BettrWebState = publicState;

export { kanbanColumns, issueMap, allIssues, changedIssueKeys, applyStatusUpdate };
